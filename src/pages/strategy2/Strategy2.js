  ...
  return (
    <div className='body-strategy2'>
        <div className='text-strategy2'>
            ...
            <p>This will be defined by the brand positioning that emerges from the the above process. This will determine priority target audiences and relevant messages. Our skill is to interpret the findings, establish an authentic brand positioning and narrative for Andover.</p>
            <p>Once we have achieved this in partnership with our stakeholders we will then develop tailored campaigns for different audiences that reflect the brand positioning. Our creative processes will ensure compelling and distinctive campaigns that will be effective.</p>
        </div>
